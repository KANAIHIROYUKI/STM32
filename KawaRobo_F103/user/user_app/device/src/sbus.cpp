...
void SBUS::setup(USART_TypeDef *usart,uint32_t baud,GPIO_TypeDef* gpio_tx,uint16_t pin_tx,GPIO_TypeDef* gpio_rx,uint16_t pin_rx){
...
void SBUS::cycle(){
	...
	if(receiveBytes == SBUS_BUFFER_END){		//25バイト目まで受信しており､END_BYTEもちゃんと受信できている｡

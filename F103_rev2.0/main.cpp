...
int main(void)
{
	...
	sw1.setup(PA2,GPIO_Mode_IPU);
	sw2.setup(PA3,GPIO_Mode_IPU);

	ledA.setup(PA4,GPIO_Mode_Out_PP);
	ledB.setup(PA5,GPIO_Mode_Out_PP);
	buzzer.setup(PB0,GPIO_Mode_Out_PP);
	...
	io1.setup(PB3,GPIO_Mode_Out_PP);
	io2.setup(PB4,GPIO_Mode_Out_PP);
	io3.setup(PB5,GPIO_Mode_Out_PP);

	motorEN.setup(PB12,GPIO_Mode_Out_PP);

	limitA1.setup(PB13,GPIO_Mode_Out_PP);
	limitA2.setup(PB14,GPIO_Mode_Out_PP);
	limitB1.setup(PB15,GPIO_Mode_Out_PP);
	limitB2.setup(PA8,GPIO_Mode_Out_PP);

	usartTX.setup(PA9,GPIO_Mode_AF_PP);
	usartRX.setup(PA10,GPIO_Mode_IN_FLOATING);
